/************************************************************************
  BeanModelGenerator.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
**************************************************************************/
package com.emitrom.touch4j.rebind;
...
import com.emitrom.touch4j.client.data.BeanModel;
import com.emitrom.touch4j.client.data.BeanModelFactory;
import com.emitrom.touch4j.client.data.BeanModelLookup;
import com.emitrom.touch4j.client.data.BeanModelMarker;
import com.emitrom.touch4j.client.data.BeanModelMarker.BEAN;
import com.emitrom.touch4j.client.data.BeanModelTag;
import com.emitrom.touch4j.client.data.NestedModelUtil;
				...
				if (returnType != null
					...
					if (beans.contains(params[0])) {
						...
						sw.println("java.util.List list2 = "
								+ BeanModelLookup.class.getCanonicalName()
								+ ".get().getFactory("
