...
public class Store extends JsObject {
	...
	private final static String BEFORE_LOAD = StoreEvents.BEFORE_LOAD
			.getValue();
	private final static String BEFORE_PREFETCH = StoreEvents.BEFORE_PREFETCH
			.getValue();
	private final static String CLEAR = StoreEvents.CLEAR.getValue();
	private final static String DATACHANGED = StoreEvents.DATACHANGED
			.getValue();
	 ...
	 * @return
	 */
	public native <T extends BaseModel> T findRecord(String fieldName,
