/************************************************************************
  TopChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class TopChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TopChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.TopChangeHandler::onTopChange(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
