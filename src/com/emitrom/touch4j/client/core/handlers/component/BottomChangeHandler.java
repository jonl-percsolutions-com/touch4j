/************************************************************************
  BottomChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class BottomChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(BottomChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.BottomChangeHandler::onBottomChange(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
