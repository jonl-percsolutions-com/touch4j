/************************************************************************
  LeftChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class LeftChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(LeftChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.LeftChangeHandler::onLeftChange(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
