/************************************************************************
  ResizeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class ResizeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ResizeHandler listener) /*-{
		return function(c, eOpts) {
			var comp = @com.emitrom.touch4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			listener.@com.emitrom.touch4j.client.core.handlers.component.ResizeHandler::fireOnEvent(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
