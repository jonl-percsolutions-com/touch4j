/************************************************************************
  DockedChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class DockedChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DockedChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.DockedChangeHandler::onDockChange(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
