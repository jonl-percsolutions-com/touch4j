/************************************************************************
  HideHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class HideHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(HideHandler listener) /*-{
		return function(c, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.HideHandler::fireOnEvent(Lcom/emitrom/touch4j/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
