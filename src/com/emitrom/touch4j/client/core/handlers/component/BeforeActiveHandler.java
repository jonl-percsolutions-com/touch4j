/************************************************************************
  BeforeActiveHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class BeforeActiveHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(BeforeActiveHandler listener) /*-{
		return function(c) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.component.BeforeActiveHandler::fireOnEvent(Lcom/emitrom/touch4j/client/core/Component;)(comp);
		};
  }-*/;
