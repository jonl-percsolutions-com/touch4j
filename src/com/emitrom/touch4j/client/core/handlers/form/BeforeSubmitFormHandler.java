/************************************************************************
  BeforeSubmitFormHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class BeforeSubmitFormHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(BeforeSubmitFormHandler listener) /*-{
		return function(source, values, options, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.form.BeforeSubmitFormHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/FormPanel;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(form, values, options, eOpts);
		};
    }-*/;
