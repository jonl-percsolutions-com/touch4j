...
public abstract class ActiveItemChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ActiveItemChangeHandler listener) /*-{
		return function(source, value, oldValue, eOpts) {
			...
			var newTab = newTab ? @com.emitrom.touch4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(value)
					: null;
			var oldTab = oldTab ? @com.emitrom.touch4j.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oldValue)
					: null;
