/************************************************************************
  TextClearIconTapHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class TextClearIconTapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextClearIconTapHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.field.text.TextClearIconTapHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/Text;Lcom/emitrom/touch4j/client/core/EventObject;Ljava/lang/Object;)(textField, eventObject, eOpts);
		};
    }-*/;
