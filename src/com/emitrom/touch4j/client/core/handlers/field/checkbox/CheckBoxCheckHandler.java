/************************************************************************
  CheckBoxCheckHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class CheckBoxCheckHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(CheckBoxCheckHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.field.checkbox.CheckBoxCheckHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/CheckBox;Ljava/lang/Object;)(checkBox, eOpts);
		};
    }-*/;
