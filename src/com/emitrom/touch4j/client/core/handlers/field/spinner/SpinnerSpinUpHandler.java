/************************************************************************
  SpinnerSpinUpHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class SpinnerSpinUpHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SpinnerSpinUpHandler listener) /*-{
		return function(source, value, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.field.spinner.SpinnerSpinUpHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/Spinner;DLjava/lang/Object;)(spinner, value, eOpts);
		};
    }-*/;
