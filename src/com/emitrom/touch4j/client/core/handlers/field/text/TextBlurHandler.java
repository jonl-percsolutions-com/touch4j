/************************************************************************
  TextBlurHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class TextBlurHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextBlurHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.field.text.TextBlurHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/Text;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(textField, event, eOpts);
		};
    }-*/;
