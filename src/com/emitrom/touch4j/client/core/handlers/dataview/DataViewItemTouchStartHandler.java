/**************************************************************************
 * DataViewItemTouchStartHandler.java is part of Touch4j 4.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class DataViewItemTouchStartHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewItemTouchStartHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.dataview.DataViewItemTouchStartHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/emitrom/touch4j/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
    }-*/;
    ...
    public abstract void onItemTouchStart(DataView dataView, double index, Element element, EventObject eventObject,
                    Object eOpts);
