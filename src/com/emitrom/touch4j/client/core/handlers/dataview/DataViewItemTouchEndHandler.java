/************************************************************************
  DataViewItemTouchEndHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class DataViewItemTouchEndHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewItemTouchEndHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.dataview.DataViewItemTouchEndHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/emitrom/touch4j/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
    }-*/;
