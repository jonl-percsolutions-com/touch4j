/************************************************************************
  NavigationViewPopHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class NavigationViewPopHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NavigationViewPopHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.navigation.NavigationViewPopHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/NavigationView;Ljava/lang/Object;)(source,eOpts);
		};
    }-*/;
