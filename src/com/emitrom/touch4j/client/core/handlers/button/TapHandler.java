/************************************************************************
  TapHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class TapHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(TapHandler listener) /*-{
		return function(source, event) {
			...
			listener.@com.emitrom.touch4j.client.core.handlers.button.TapHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/Button;Lcom/emitrom/touch4j/client/core/EventObject;)(btn, e);
		};
  }-*/;
