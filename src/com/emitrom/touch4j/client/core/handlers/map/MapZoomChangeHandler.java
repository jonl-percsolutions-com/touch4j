/************************************************************************
  MapZoomChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class MapZoomChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapZoomChangeHandler listener) /*-{
			return function(source, googlemap, mapZom) {
				...
				listener.@com.emitrom.touch4j.client.core.handlers.map.MapZoomChangeHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;D)(map,googlemap,mapzoom);
			};
	  }-*/;
