/************************************************************************
  MapTypeChangeHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public abstract class MapTypeChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapTypeChangeHandler listener) /*-{
			return function(source, googlemap, maptype) {
				...
				listener.@com.emitrom.touch4j.client.core.handlers.map.MapTypeChangeHandler::fireOnEvent(Lcom/emitrom/touch4j/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;D)(map,googlemap,maptype);
			};
	  }-*/;
