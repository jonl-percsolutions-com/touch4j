/************************************************************************
  ExtElement.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public class ExtElement extends JsObject {
    ...
    public static native ExtElement fly(String id)/*-{
		...
		return elem == null || elem === undefined ? null
				: @com.emitrom.touch4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
    }-*/;
    ...
    public native ExtElement boxWrap() /*-{
		...
		return @com.emitrom.touch4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(wrap);
    }-*/;
    ...
    public native ExtElement createChild(DOMConfig config) /*-{
		var configJS = config.@com.emitrom.touch4j.client.core.DOMConfig::getJsObject()();
		var elem = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		var childJS = elem.createChild(configJS);
		var childJ = @com.emitrom.touch4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
		return childJ;
    }-*/;
    ...
    public native ExtElement createProxy(DOMConfig config) /*-{
		...
		var proxyJ = @com.emitrom.touch4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(proxy);
		return proxyJ;
    }-*/;
    ...
    public native int[] getAlignToXY(Element element, String anchorPosition) /*-{
		...
		return @com.emitrom.touch4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)(arrJS);
    }-*/;
    ...
    public native int[] getAlignToXY(Element element, String anchorPosition, int[] offesets) /*-{
		var elem = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		var offsetsJS = @com.emitrom.touch4j.client.core.JsoHelper::convertToJavaScriptArray([I)(offesets);
    ...
    public native int getBorderWidth(Side side)/*-{
		var elem = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		var sideJS = side.@com.emitrom.touch4j.client.core.Side::getSide()();
    ...
    public native Box getBox()/*-{
		...
		return @com.emitrom.touch4j.client.core.Box::new(Lcom/google/gwt/core/client/JavaScriptObject;)(boxJS);
    }-*/;
    ...
    public native Element getDOM()/*-{
		var element = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		var dom = element.dom;
    ...
    public native int[] getScroll()/*-{
		...
		return @com.emitrom.touch4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)([scroll.left, scroll.top]);
    }-*/;
    ...
    public native Size getSize()/*-{
		...
		return @com.emitrom.touch4j.client.core.Size::new(Lcom/google/gwt/core/client/JavaScriptObject;)(sizeJS);
    }-*/;
    ...
    public native ExtElement mask()/*-{
		var elem = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		var me = elem.mask();
		return @com.emitrom.touch4j.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(me);
    }-*/;
    ...
    public native Element[] query(String selector)/*-{
		...
		return elemsJS == null || elemsJS === undefined ? null
				: @com.emitrom.touch4j.client.core.JsoHelper::toElementArray(Lcom/google/gwt/core/client/JavaScriptObject;)(elemsJS);
    }-*/;
    ...
    public native CompositeElement select(String selector)/*-{
		...
		return ceJS == null || ceJS === undefined ? null
				: @com.emitrom.touch4j.client.core.CompositeElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ceJS);
    }-*/;
    ...
    public native CompositeElement select(String selector, boolean unique)/*-{
		...
		if (unique) {
			...
			return ceJS == null || ceJS === undefined ? null
					: @com.emitrom.touch4j.client.core.CompositeElementLite::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ceJS);
		}
    }-*/;
    ...
    public native int[] translatePoints(int x, int y)/*-{
		...
		return @com.emitrom.touch4j.client.core.JsoHelper::convertToJavaIntArray(Lcom/google/gwt/core/client/JavaScriptObject;)([leftTopJS.left, leftTopJS.top]);
    }-*/;
