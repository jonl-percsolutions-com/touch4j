/************************************************************************
  Button.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public class Button extends Component implements HasUi, HasIcon,
	...
	public enum IconAlign {
		...
		BOTTOM(Attribute.BOTTOM.getValue()), CENTER(Attribute.CENTER.getValue()), LEFT(
				Attribute.LEFT.getValue()), RIGHT(Attribute.RIGHT.getValue()), TOP(
				Attribute.TOP.getValue());
