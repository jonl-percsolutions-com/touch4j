/************************************************************************
  DataView.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public class DataView extends Container implements HasStore, ListView {
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getPressedCls()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getPressedDelay()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getSelectedCls()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.ui.ListView#refresh()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.ui.ListView#setDeselectOnContainerClick
     *      (boolean)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.touch4j.client.dataview.ListView#setSelectedCls(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#deferEmptyText()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getEmptyText()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getItemTpl()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.touch4j.client.dataview.ListView#setLoadingText(java.lang
     * .String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.touch4j.client.dataview.ListView#getLoaddingText()
     */
    @Override
