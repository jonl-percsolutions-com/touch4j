/************************************************************************
  SegmentedButton.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public class SegmentedButton extends Container implements HasToggleHandler {
    ...
    public native void applyItems() /*-{
		var segmentedButton = this.@com.emitrom.touch4j.client.core.Component::getOrCreateJsObj()();
