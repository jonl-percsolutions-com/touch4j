/************************************************************************
  ItemShowHandler.java is part of Touch4j 4.2.2.1  Copyright 2013 Emitrom LLC
...
public interface ItemShowHandler {
    public abstract void onItemShow(ItemInfo itemInfo, ChartItem item, Panel panel);
}
