/**************************************************************************
 * ItemCompare.java is part of Touch4j 4.0. Copyright 2012 Emitrom LLC
 * 
...
public class ItemCompare extends AbstractInteraction {
    ...
    public native void setArrow(Sprite value)/*-{
		...
		jso.arrow = value.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
    }-*/;

    public native void setCircle(Sprite value)/*-{
		var jso = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		jso.circle = value.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		;
    }-*/;

    public native void setLine(Sprite value)/*-{
		var jso = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		jso.line = value.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
    }-*/;

    public native void setOffset(OffsetValue value)/*-{
		var jso = this.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
		jso.offset = value.@com.emitrom.touch4j.client.core.JsObject::getJsObj()();
    }-*/;
    ...
    public native void addInteractionHandler(ItemCompareInteractionHandler handler)/*-{
		...
		jso.listeners = {
			show : function(itemcompare) {
				var itemCompareObject = @com.emitrom.touch4j.charts.client.interactions.ItemCompare::new(Lcom/google/gwt/core/client/JavaScriptObject;)(itemcompare);
				handler.@com.emitrom.touch4j.charts.client.handlers.ItemCompareInteractionHandler::onShow(Lcom/emitrom/touch4j/charts/client/interactions/ItemCompare;)(itemCompareObject);
			},
			hide : function() {
				handler.@com.emitrom.touch4j.charts.client.handlers.ItemCompareInteractionHandler::onHide()();
			}
		};
    }-*/;
