/**************************************************************************
 * PieGrouping.java is part of Touch4j 4.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.touch4j.charts.client.handlers.SelectionChangeHandler;
		...
		jso
				.addChartListener(
						...
						$entry(function(pie, items) {
							pieGrouping = @com.emitrom.touch4j.charts.client.interactions.PieGrouping::new(Lcom/google/gwt/core/client/JavaScriptObject;)(pie);
							var chartItems = @com.emitrom.touch4j.charts.client.interactions.ChartItem::fromJsArray(Lcom/google/gwt/core/client/JsArray;)(items);
							handler.@com.emitrom.touch4j.charts.client.handlers.SelectionChangeHandler::onSelectionChange(Lcom/emitrom/touch4j/charts/client/interactions/PieGrouping;Ljava/util/List;)(pie, chartItems);
						}));
    }-*/;
