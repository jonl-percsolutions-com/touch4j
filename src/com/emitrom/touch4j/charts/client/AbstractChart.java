/************************************************************************
 * AbstractChart.java is part of Touch4j 4.2.2.1 Copyright 2013 Emitrom LLC
 * 
...
public abstract class AbstractChart extends DrawComponent {
    ...
    public native Toolbar getToolbar()/*-{
		...
		var toReturn = @com.emitrom.touch4j.charts.client.Toolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tb);
		return toReturn;
    }-*/;
    ...
    public native void bindStore(Store store)/*-{
		var component = this.@com.emitrom.touch4j.client.core.Component::getOrCreateJsObj()();
		component
				.bindStore(store.@com.emitrom.touch4j.client.core.JsObject::getJsObj()());
    }-*/;
