/**************************************************************************
 * Store.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.gwt4.touch.client.core.Ext;
import com.emitrom.gwt4.touch.client.core.config.StoreEvents;
import com.emitrom.gwt4.touch.client.data.handlers.BeforeLoadHandler;
import com.emitrom.gwt4.touch.client.data.handlers.BeforePrefetchHandler;
import com.emitrom.gwt4.touch.client.data.handlers.ClearHandler;
import com.emitrom.gwt4.touch.client.data.handlers.DataAddedHandler;
import com.emitrom.gwt4.touch.client.data.handlers.DataChangedHandler;
import com.emitrom.gwt4.touch.client.data.handlers.EachCallBack;
    ...
    public native void addDataAddedHandler(DataAddedHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store, data) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.DataAddedHandler::onAdd(Lcom/emitrom/gwt4/touch/client/data/Store;Lcom/google/gwt/core/client/JavaScriptObject;)(s, data);
						});
    }-*/;
    ...
    public native void addBeforeLoadHandler(BeforeLoadHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.BeforeLoadHandler::onBeforeLoad(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addBeforePrefetch(BeforePrefetchHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.BeforePrefetchHandler::onBeforePrefetch(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addClearHandler(ClearHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.ClearHandler::onClear(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addDataChangedHandler(DataChangedHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.DataChangedHandler::onDataChanged(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addRemoveHandler(RemoveHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.RemoveHandler::onRemove(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
    ...
    public native void addUpdateHandler(UpdateHandler handler)/*-{
		...
		jso
				.addListener(
						...
						function(store) {
							var s = @com.emitrom.gwt4.touch.client.data.Store::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
							handler.@com.emitrom.gwt4.touch.client.data.handlers.UpdateHandler::onUpdate(Lcom/emitrom/gwt4/touch/client/data/Store;)(s);
						});
    }-*/;
