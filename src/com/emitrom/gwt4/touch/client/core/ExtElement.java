...
public class ExtElement extends JsObject {
    ...
    public static native ExtElement fly(String id)/*-{
		...
		return elem == null || elem === undefined ? null
				: @com.emitrom.gwt4.touch.client.core.ExtElement::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(elem);
    }-*/;
    ...
    public native CompositeElement select(String selector, boolean unique)/*-{
		...
		if (unique) {
			...
			return ceJS == null || ceJS === undefined ? null
					: @com.emitrom.gwt4.touch.client.core.CompositeElementLite::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ceJS);
		}
    }-*/;
