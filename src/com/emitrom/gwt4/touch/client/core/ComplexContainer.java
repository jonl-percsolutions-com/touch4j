/**************************************************************************
 * ComplexContainer.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class ComplexContainer extends Component implements HasWidgets, HasItems {
    ...
    public native Component[] getComponents()/*-{
                                             ...
                                             return @com.emitrom.gwt4.touch.client.core.TouchJsoHelper::convertToJavaComponentArray(Lcom/google/gwt/core/client/JavaScriptObject;)(items);
                                             }-*/;
    ...
    private native void remove(Component component, boolean autoDestroy) /*-{
                                                                         var container = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
                                                                         var componentJS = component.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
