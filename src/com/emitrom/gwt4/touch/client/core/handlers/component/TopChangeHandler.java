/**************************************************************************
   TopChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class TopChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TopChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.TopChangeHandler::onTopChange(Lcom/emitrom/gwt4/touch/client/core/Component;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
