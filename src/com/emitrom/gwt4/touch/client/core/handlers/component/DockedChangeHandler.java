/**************************************************************************
   DockedChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class DockedChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DockedChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.DockedChangeHandler::onDockChange(Lcom/emitrom/gwt4/touch/client/core/Component;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
