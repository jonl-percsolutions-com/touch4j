/**************************************************************************
 * SpinnerSpinDownHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom
 * LLC
 * 
...
public abstract class SpinnerSpinDownHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SpinnerSpinDownHandler listener) /*-{
		return function(source, value, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.spinner.SpinnerSpinDownHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Spinner;DLjava/lang/Object;)(spinner, value, eOpts);
		};
    }-*/;
