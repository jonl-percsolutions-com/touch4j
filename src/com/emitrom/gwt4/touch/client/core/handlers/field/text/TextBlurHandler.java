/**************************************************************************
 * TextBlurHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class TextBlurHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextBlurHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.text.TextBlurHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Text;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(textField, event, eOpts);
		};
    }-*/;
