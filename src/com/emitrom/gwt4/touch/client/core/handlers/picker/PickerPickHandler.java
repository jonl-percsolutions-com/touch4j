...
public abstract class PickerPickHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(PickerPickHandler listener) /*-{
		return function(source, slotValues, slot, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.picker.PickerPickHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(picker, slotValues, slot, eOpts);
		};
    }-*/;
