/**************************************************************************
   MapTypeChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class MapTypeChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapTypeChangeHandler listener) /*-{
			return function(source, googlemap, maptype) {
				...
				listener.@com.emitrom.gwt4.touch.client.core.handlers.map.MapTypeChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;D)(map,googlemap,maptype);
			};
	  }-*/;
