/**************************************************************************
 * NestedListBeforeLoadHandler.java is part of Touch4j 3.0. Copyright 2012
 * Emitrom LLC
 * 
...
public abstract class NestedListBeforeLoadHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NestedListBeforeLoadHandler listener) /*-{
		return function(source, store, operation, eOpts, handler) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListBeforeLoadHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/NestedListDataView;Lcom/emitrom/gwt4/touch/client/data/Store;Ljava/lang/Object;Ljava/lang/Object;)(nestedList, store, operation, eOpts, handler);
		};
    }-*/;
