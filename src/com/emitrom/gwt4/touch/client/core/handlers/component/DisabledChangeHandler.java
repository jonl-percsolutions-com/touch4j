/**************************************************************************
   DisabledChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class DisabledChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DisabledChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.DisabledChangeHandler::onDisabledChange(Lcom/emitrom/gwt4/touch/client/core/Component;ZZLjava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
