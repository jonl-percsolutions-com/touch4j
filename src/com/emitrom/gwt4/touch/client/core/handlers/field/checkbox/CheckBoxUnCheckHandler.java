...
public abstract class CheckBoxUnCheckHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(CheckBoxUnCheckHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.checkbox.CheckBoxUnCheckHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/CheckBox;Ljava/lang/Object;)(checkBox, eOpts);
		};
    }-*/;
