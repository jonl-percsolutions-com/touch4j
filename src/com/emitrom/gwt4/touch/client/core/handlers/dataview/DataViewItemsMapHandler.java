/**************************************************************************
 * DataViewItemsMapHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom
 * LLC
 * 
...
public abstract class DataViewItemsMapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewItemsMapHandler listener) /*-{
		return function(source, index, element, eventObject, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemsMapHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/DataView;DLcom/google/gwt/dom/client/Element;Lcom/emitrom/gwt4/touch/client/core/EventObject;Ljava/lang/Object;)(dataView, index, element, eventObject, eOpts);
		};
    }-*/;
