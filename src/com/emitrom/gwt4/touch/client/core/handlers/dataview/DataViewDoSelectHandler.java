...
public abstract class DataViewDoSelectHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(DataViewDoSelectHandler listener) /*-{
		return function(source, record, supressed, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewDoSelectHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/DataView;Lcom/emitrom/platform/util/client/core/BaseModel;Ljava/lang/Boolean;Ljava/lang/Object;)(dataView,model, supressed, eOpts);
		};
    }-*/;
