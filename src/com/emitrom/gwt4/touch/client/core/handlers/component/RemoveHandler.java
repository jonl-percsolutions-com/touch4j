/**************************************************************************
 * RemoveHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class RemoveHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(RemoveHandler listener) /*-{
		return function(c, o) {
			...
			var owner = @com.emitrom.gwt4.touch.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.RemoveHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;Lcom/emitrom/gwt4/touch/client/ui/Container;)(comp, owner);
		};
    }-*/;
