/**************************************************************************
 * OrientationChangeHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom
 * LLC
 * 
...
public abstract class OrientationChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(OrientationChangeHandler listener) /*-{
                                                                                         ...
                                                                                         var viewPort = @com.emitrom.gwt4.touch.client.ui.ViewPort::get()();
                                                                                         listener.@com.emitrom.gwt4.touch.client.core.handlers.component.OrientationChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/ViewPort;Ljava/lang/String;IILjava/lang/Object;)(viewPort, orientation, width, height, eOpts);
                                                                                         };
                                                                                         }-*/;
