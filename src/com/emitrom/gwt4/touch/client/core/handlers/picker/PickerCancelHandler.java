/**************************************************************************
 * PickerCancelHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class PickerCancelHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(PickerCancelHandler listener) /*-{
		return function(source, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.picker.PickerCancelHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Picker;Ljava/lang/Object;)(picker, eOpts);
		};
    }-*/;
