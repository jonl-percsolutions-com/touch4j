/**************************************************************************
   ImageTapHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class ImageTapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ImageTapHandler listener) /*-{
		return function(source, eventObject, eOpts) {
			var image = @com.emitrom.gwt4.touch.client.ui.Image::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			var e = @com.emitrom.gwt4.touch.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(eventObject);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.image.ImageTapHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Image;Lcom/emitrom/gwt4/touch/client/core/EventObject;Ljava/lang/Object;)(image, e, eOpts);
		};
    }-*/;
