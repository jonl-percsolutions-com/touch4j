/**************************************************************************
   HeightChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class HeightChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(HeightChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.HeightChangeHandler::onHeightChange(Lcom/emitrom/gwt4/touch/client/core/Component;DDLjava/lang/Object;)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
