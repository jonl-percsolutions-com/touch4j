/**************************************************************************
   PickerChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.client.core.handlers.picker;

import com.emitrom.gwt4.touch.client.core.handlers.AbstractHandler;
import com.emitrom.gwt4.touch.client.ui.Picker;
...
public abstract class PickerChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(PickerChangeHandler listener) /*-{
		return function(source, slotValues, eOpts) {
			var picker = @com.emitrom.gwt4.touch.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.picker.PickerChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/Object;)(picker, slotValues, eOpts);
		};
    }-*/;
