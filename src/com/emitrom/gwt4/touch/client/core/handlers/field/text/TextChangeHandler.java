/**************************************************************************
 * TextChangeHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class TextChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextChangeHandler listener) /*-{
		return function(source, oldValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.text.TextChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Text;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(textField,oldValue, newValue, eOpts);
		};
    }-*/;
