/**************************************************************************
   MoveHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class MoveHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(MoveHandler listener) /*-{
		return function(c, x, y) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.MoveHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;DD)(comp, x, y);
		};
  }-*/;
