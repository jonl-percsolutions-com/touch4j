/**************************************************************************
   MaskTapHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.client.core.handlers.mask;

import com.emitrom.gwt4.touch.client.core.handlers.AbstractHandler;
import com.emitrom.gwt4.touch.client.ui.Mask;
...
public abstract class MaskTapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(MaskTapHandler listener) /*-{
		return function(source, eventObject, eOpts) {
			var mask = @com.emitrom.gwt4.touch.client.ui.Mask::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.mask.MaskTapHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Mask;Ljava/lang/Object;Ljava/lang/Object;)(mask,eventObject, eOpts);
		};
    }-*/;
