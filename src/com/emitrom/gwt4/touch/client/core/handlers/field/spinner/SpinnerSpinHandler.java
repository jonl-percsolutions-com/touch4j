/**************************************************************************
 * SpinnerSpinHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class SpinnerSpinHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SpinnerSpinHandler listener) /*-{
		return function(source, value, direction, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.spinner.SpinnerSpinHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Spinner;DLjava/lang/String;Ljava/lang/Object;)(spinner, value, direction, eOpts);
		};
    }-*/;
