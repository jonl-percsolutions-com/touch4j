/**************************************************************************
 * ResizeHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class ResizeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ResizeHandler listener) /*-{
		return function(c, eOpts) {
			var comp = @com.emitrom.gwt4.touch.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.ResizeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
