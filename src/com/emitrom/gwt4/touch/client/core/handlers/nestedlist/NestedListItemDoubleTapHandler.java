...
public abstract class NestedListItemDoubleTapHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NestedListItemDoubleTapHandler listener) /*-{
		return function(source, listView, index, item, event, eOpts) {
			...
			var listViewObject = @com.emitrom.gwt4.touch.client.ui.ListDataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(listView);
			var e = @com.emitrom.gwt4.touch.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListItemDoubleTapHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/NestedListDataView;Lcom/emitrom/gwt4/touch/client/ui/ListDataView;ILjava/lang/Object;Lcom/emitrom/gwt4/touch/client/core/EventObject;Ljava/lang/Object;)(nestedList, listViewObject, index, item, e, eOpts);
		};
    }-*/;
