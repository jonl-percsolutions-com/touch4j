 ...
 * the License.
 **************************************************************************/
package com.emitrom.gwt4.touch.client.core.handlers.segmentedbutton;

import com.emitrom.gwt4.touch.client.core.handlers.AbstractHandler;
import com.emitrom.gwt4.touch.client.ui.Button;
import com.emitrom.gwt4.touch.client.ui.SegmentedButton;
...
public abstract class ToggleHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ToggleHandler listener) /*-{
		return function(segmentedBtn, button, pressed) {
			var element = @com.emitrom.gwt4.touch.client.ui.SegmentedButton::new(Lcom/google/gwt/core/client/JavaScriptObject;)(segmentedBtn);
			var buttonObject = @com.emitrom.gwt4.touch.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(button);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.segmentedbutton.ToggleHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/SegmentedButton;Lcom/emitrom/gwt4/touch/client/ui/Button;Z)(element,buttonObject, pressed);
		};
    }-*/;
