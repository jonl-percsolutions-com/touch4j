/**************************************************************************
 * ShowHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class ShowHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(ShowHandler listener) /*-{
		return function(source, eOpts) {
			var comp = @com.emitrom.gwt4.touch.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.ShowHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
