/**************************************************************************
 * SelectChangeHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
 ...
 * the License.
 **************************************************************************/
package com.emitrom.gwt4.touch.client.core.handlers.field.select;
...
public abstract class SelectChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SelectChangeHandler listener) /*-{
		return function(source, oldValue, newValue, eOpts) {
			var select = @com.emitrom.gwt4.touch.client.ui.Select::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.select.SelectChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Select;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)(select, newValue, oldValue, eOpts);
		};
    }-*/;
