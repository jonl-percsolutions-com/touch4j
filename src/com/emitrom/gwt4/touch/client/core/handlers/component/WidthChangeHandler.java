/**************************************************************************
   WidthChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class WidthChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(WidthChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.WidthChangeHandler::onWidthChange(Lcom/emitrom/gwt4/touch/client/core/Component;DDD)(comp, existingValue, newValue, eOpts);
		};
    }-*/;
