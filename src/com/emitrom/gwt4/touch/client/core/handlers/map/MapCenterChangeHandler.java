/**************************************************************************
   MapCenterChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class MapCenterChangeHandler extends AbstractHandler {
	  ...
	  private static native JavaScriptObject createPeer(MapCenterChangeHandler listener) /*-{
			return function(source, googlemap, latlgn) {
				...
				listener.@com.emitrom.gwt4.touch.client.core.handlers.map.MapCenterChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/GoogleMap;Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;)(map,googlemap, latlgn);
			};
	  }-*/;
