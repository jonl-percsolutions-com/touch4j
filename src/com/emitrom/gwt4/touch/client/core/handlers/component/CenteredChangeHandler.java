/**************************************************************************
   CenteredChangeHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class CenteredChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(CenteredChangeHandler listener) /*-{
		return function(component, existingValue, newValue, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.CenteredChangeHandler::onCenteredChange(Lcom/emitrom/gwt4/touch/client/core/Component;ZZLjava/lang/Object;)(component, existingValue, newValue, eOpts);
		};
    }-*/;
