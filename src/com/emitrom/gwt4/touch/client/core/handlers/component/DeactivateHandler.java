/**************************************************************************
   DeactivateHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class DeactivateHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(DeactivateHandler listener) /*-{
		return function(c) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.DeactivateHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;)(comp);
		};
  }-*/;
