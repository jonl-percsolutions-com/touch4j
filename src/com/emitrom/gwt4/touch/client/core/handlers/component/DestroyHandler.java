/**************************************************************************
   DestroyHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class DestroyHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(DestroyHandler listener) /*-{
		return function(c) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.DestroyHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;)(comp);
		};
  }-*/;
