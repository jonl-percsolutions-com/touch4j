/**************************************************************************
   NavigationViewEventHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public abstract class NavigationViewEventHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NavigationViewEventHandler listener) /*-{
		return function(view, eOpts) {
			var navView = @com.emitrom.gwt4.touch.client.ui.NavigationView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(view);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.navigation.NavigationViewEventHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/NavigationView;Ljava/lang/Object;)(view,eOpts);
		};
    }-*/;
