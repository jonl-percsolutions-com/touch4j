/**************************************************************************
 * HideHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class HideHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(HideHandler listener) /*-{
		return function(c, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.component.HideHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/core/Component;Ljava/lang/Object;)(comp, eOpts);
		};
    }-*/;
