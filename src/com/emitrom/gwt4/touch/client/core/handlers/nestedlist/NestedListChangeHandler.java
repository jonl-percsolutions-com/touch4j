/**************************************************************************
 * NestedListChangeHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom
 * LLC
 * 
...
public abstract class NestedListChangeHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(NestedListChangeHandler listener) /*-{
		return function(source, listitem, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListChangeHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/NestedListDataView;Ljava/lang/Object;Ljava/lang/Object;)(nestedList, listitem, eOpts);
		};
    }-*/;
