/**************************************************************************
 * SubmitFormHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class SubmitFormHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(SubmitFormHandler listener) /*-{
		return function(source, result, event, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.form.SubmitFormHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/FormPanel;Ljava/lang/Object;Lcom/emitrom/gwt4/touch/client/core/EventObject;Ljava/lang/Object;)(form, result, event, eOpts);
		};
    }-*/;
