/**************************************************************************
 * TextKeyUpHandler.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public abstract class TextKeyUpHandler extends AbstractHandler {
    ...
    private static native JavaScriptObject createPeer(TextKeyUpHandler listener) /*-{
		return function(source, event, eOpts) {
			...
			listener.@com.emitrom.gwt4.touch.client.core.handlers.field.text.TextKeyUpHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Text;Lcom/emitrom/gwt4/touch/client/core/EventObject;Ljava/lang/Object;)(textField, eventObject, eOpts);
		};
    }-*/;
