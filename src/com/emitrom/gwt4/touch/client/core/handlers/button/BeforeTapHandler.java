/**************************************************************************
   BeforeTapHandler.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.client.core.handlers.button;
...
public abstract class BeforeTapHandler extends AbstractHandler {
  ...
  private static native JavaScriptObject createPeer(BeforeTapHandler listener) /*-{
		return function(source, event) {
			var btn = @com.emitrom.gwt4.touch.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(source);
			var e = (event === undefined || event == null) ? null
					: @com.emitrom.gwt4.touch.client.core.EventObject::new(Lcom/google/gwt/core/client/JavaScriptObject;)(event);
			listener.@com.emitrom.gwt4.touch.client.core.handlers.button.BeforeTapHandler::fireOnEvent(Lcom/emitrom/gwt4/touch/client/ui/Button;Lcom/emitrom/gwt4/touch/client/core/EventObject;)(btn,e);
		};
  }-*/;
