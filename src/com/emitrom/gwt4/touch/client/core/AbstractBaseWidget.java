/**************************************************************************
   AbstractBaseWidget.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public class AbstractBaseWidget
{
    ...
    protected native void addWidgetListener(String event, JavaScriptObject fn) /*-{
        var component = this.@com.emitrom.gwt4.touch.client.core.AbstractBaseWidget::getOrCreateJsObj()();
    ...
    public native boolean isRendered() /*-{
        var component = this.@com.emitrom.gwt4.touch.client.core.AbstractBaseWidget::getJsObj()();
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.core.EventDispatcher#addEvent(java.lang.String)
     */
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.core.EventDispatcher#fireEvent(java.lang
     * .String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.core.EventDispatcher#purgeListeners()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.core.EventDispatcher#resumeEvents()
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.core.EventDispatcher#suspendEvents()
     */
