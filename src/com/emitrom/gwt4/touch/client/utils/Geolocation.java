/**************************************************************************
   Geolocation.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.client.utils;

import com.emitrom.gwt4.touch.client.core.Observable;
 ...
 */
/**
 * According to the Sencha Documentation this feature does not work at this point.
 */
public class Geolocation implements Observable {
    ...
    private native void create()/*-{
		this.@com.emitrom.gwt4.touch.client.utils.Geolocation::jso = new $wnd.Ext.utils.Geolocation();
    }-*/;
