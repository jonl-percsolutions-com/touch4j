/**************************************************************************
   AbstractLayout.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
public class AbstractLayout {
    ...
    public native Animation getAnimation() /*-{
		var jso = this.@com.emitrom.gwt4.touch.client.layout.AbstractLayout::getJSO()();
		var obj = jso.getAnimation();
		var toReturn = @com.emitrom.gwt4.touch.client.fx.layout.card.Animation::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
    }-*/;
