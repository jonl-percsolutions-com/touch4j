...
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewDoSelectHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemDoubleTapHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemSwipeHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemTapHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemTouchEndHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewItemTouchStartHandler;
import com.emitrom.gwt4.touch.client.core.handlers.dataview.DataViewRefreshHandler;
...
public class DataView extends Container implements HasStore, ListView {
    ...
    public native Boolean getDeselectOnContainerClick() /*-{
		var dataview = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getPressedCls()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getPressedDelay()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getSelectedCls()
     */
    ...
    private native Store _getStore()/*-{
		...
		return @com.emitrom.gwt4.touch.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
    }-*/;
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.ui.ListView#refresh()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.ui.ListView#setDeselectOnContainerClick
     *      (boolean)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setPressedCls(java.lang
     * .String)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setPressedDelay(double)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setSelectedCls(java.lang
     * .String)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setDeferEmptyText(boolean
     * )
     */
    @Override
    public void setDeferEmptyText(boolean value) {
        setAttribute(Attribute.DEFER_EMPTY_TEXT.getValue(), value, true);
    }

    /*
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#deferEmptyText()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setEmptyText(java.lang
     * .String)
     */
    @Override
    public void setEmptyText(String value) {
        setAttribute(Attribute.EMPTY_TEXT.getValue(), value, true);
    }

    /*
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getEmptyText()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setItemTpl(java.lang.
     * String)
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setItemTpl(com.emitrom
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getItemTpl()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#setLoadingText(java.lang
     * .String)
     */
    @Override
    public void setLoadingText(String value) {
        setAttribute(Attribute.LOADING_TEXT.getValue(), value, true);
    }

    /*
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.dataview.ListView#getLoaddingText()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.dataview.ListView#deselectOnContainerClick
     * ()
     */
    @Override
