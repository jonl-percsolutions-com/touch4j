/**************************************************************************
 * NestedListDataView.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListBeforeLoadHandler;
import com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListBeforeSelectHandler;
import com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListChangeHandler;
import com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListItemDoubleTapHandler;
import com.emitrom.gwt4.touch.client.core.handlers.nestedlist.NestedListItemTapHandler;
...
public class NestedListDataView extends Container {
    ...
    public native boolean getAllowDeselect() /*-{
		var nestedlist = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
    ...
    public native void setToolBar(ToolBar toolbar) /*-{
		var nestedlist = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		nestedlist
				.setToolBar(toolbar.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()());
    }-*/;
