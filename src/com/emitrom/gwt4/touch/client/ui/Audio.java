/**************************************************************************
   Audio.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.touch.client.core.Media;
...
public class Audio extends Media {
    ...
    private Audio(JavaScriptObject config) {
        super(config);
    }
    ...
    public native String getUrl() /*-{
		var audio = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		return audio.getUrl();
    }-*/;
