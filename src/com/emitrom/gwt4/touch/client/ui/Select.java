...
import com.emitrom.gwt4.touch.client.core.config.SelectConfig;
import com.emitrom.gwt4.touch.client.core.config.XType;
import com.emitrom.gwt4.touch.client.core.handlers.field.select.SelectChangeHandler;
...
public class Select<T> extends Text<T> implements HasStore {
    ...
    public native Store getStore()/*-{
		var select = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
