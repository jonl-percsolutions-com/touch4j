    ...
    public static native void alert(String title, String message, AlertCallback cb) /*-{
		$wnd.Ext.Msg
				.alert(
						...
						message,
						function() {
							cb.@com.emitrom.gwt4.touch.client.ui.MessageBox.AlertCallback::execute()();
						});
    }-*/;
    ...
    public static native void confirm(String title, String message, ConfirmCallback cb) /*-{
		$wnd.Ext.Msg
				.confirm(
						...
						message,
						function(btnID) {
							cb.@com.emitrom.gwt4.touch.client.ui.MessageBox.ConfirmCallback::execute(Ljava/lang/String;)(btnID);
						});
    }-*/;
