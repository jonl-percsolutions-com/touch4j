/**************************************************************************
   DatePicker.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.touch.client.core.config.DatePickerConfig;
import com.emitrom.gwt4.touch.client.core.config.Event;
import com.emitrom.gwt4.touch.client.core.config.XType;
import com.emitrom.gwt4.touch.client.core.handlers.field.datepicker.DatePickerChangeHandler;
...
public class DatePickerField extends Text<JsDate> {
    ...
    public native boolean getDestroyPickerOnHide() /*-{
		var comp = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (comp != null) {
     ...
     * @param handler
     */
    public void addChangeHandler(DatePickerChangeHandler handler) {
