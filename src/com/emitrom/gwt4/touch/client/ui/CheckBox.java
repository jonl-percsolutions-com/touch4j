/**************************************************************************
   CheckBox.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.touch.client.core.config.CheckBoxConfig;
import com.emitrom.gwt4.touch.client.core.config.Event;
import com.emitrom.gwt4.touch.client.core.config.XType;
import com.emitrom.gwt4.touch.client.core.handlers.field.checkbox.CheckBoxCheckHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.checkbox.CheckBoxUnCheckHandler;
...
public class CheckBox extends Field implements HasValue<Boolean>, IsEditor<LeafValueEditor<Boolean>> {
	...
	public native void check() /*-{
		var checkBox = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (checkBox != null) {
			checkBox.check();
		}
	}-*/;
	...
	// var checkBox =
	// this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
	// if (checkBox != null) {
