/**************************************************************************
   Sheet.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 * <ul>
 * <li>com.emitrom.gwt4.touch.client.containers.ActionSheet
 * <li>com.emitrom.gwt4.touch.client.containers.MessageBox
 * <li>com.emitrom.gwt4.touch.client.containers.Picker
 * <li>com.emitrom.gwt4.touch.client.containers.DatePicker
 * </ul>
 * 
...
public class Sheet extends Panel {
    ...
    public native boolean isCentered() /*-{
		var sheet = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
    ...
    public void addCenteredChangeHandler(CenteredChangeHandler handler) {
        this.addWidgetListener(Event.CENTERED_CHANGED.getValue(), handler.getJsoPeer());
    }
