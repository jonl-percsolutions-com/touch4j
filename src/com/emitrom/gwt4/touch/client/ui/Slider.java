/**************************************************************************
   Slider.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.touch.client.core.config.SliderConfig;
import com.emitrom.gwt4.touch.client.core.config.XType;
import com.emitrom.gwt4.touch.client.core.handlers.field.slider.SliderChangeHandler;
...
public class Slider extends Field implements HasValue<Integer>, IsEditor<LeafValueEditor<Integer>> {
	 ...
	 * @param handler
	 */
	public void addChangeHandler(SliderChangeHandler handler) {
