/**************************************************************************
   Spacer.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 * com.emitrom.gwt4.touch.client.containers.Toolbar components.
 * 
...
public class Spacer extends Component {
    ...
    public native int getFlex() /*-{
        var spacer = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
