/**************************************************************************
 * NavigationView.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.gwt4.touch.client.core.handlers.navigation.NavigationViewEventHandler;
...
public class NavigationView extends Container {
    ...
    public native String getDefaultBackButtonText() /*-{
		var view = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (view != null) {
    ...
    public native NavigationBar getNavigationBar() /*-{
		...
		if (view != null) {
			...
			return @com.emitrom.gwt4.touch.client.ui.NavigationBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		}
    }-*/;
    ...
    public native Container getPreviousItem() /*-{
		...
		if (view != null) {
			...
			return @com.emitrom.gwt4.touch.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		}
    }-*/;
    ...
    public native void push(Container element) /*-{
		var view = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		var component = element.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (view != null) {
			view.push(component);
		}
    }-*/;
