/**************************************************************************
 * Text.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.gwt4.touch.client.core.config.TextConfig;
import com.emitrom.gwt4.touch.client.core.config.XType;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextActionHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextBlurHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextChangeHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextClearIconTapHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextFocusHandler;
import com.emitrom.gwt4.touch.client.core.handlers.field.text.TextKeyUpHandler;
...
public class Text<T> extends Field implements HasValue<T>, IsEditor<LeafValueEditor<T>> {
    ...
    public native void blur() /*-{
		var text = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (text != null) {
			text.blur();
		}
    }-*/;
    ...
    private native void _setValue(T value) /*-{
		var field = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (field != null) {
    ...
    private native T _getValue() /*-{
		...
		if (field != null) {
			...
			switch (type) {
			case 'number': {
				return @com.emitrom.gwt4.touch.client.ui.Text::getDouble(D)(value);
			}
			}
