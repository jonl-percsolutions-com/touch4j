/**************************************************************************
 * Container.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
import com.emitrom.gwt4.touch.client.core.ComplexContainer;
import com.emitrom.gwt4.touch.client.core.Component;
import com.emitrom.gwt4.touch.client.core.DefaultsHandler;
import com.emitrom.gwt4.touch.client.core.HasLayout;
import com.emitrom.gwt4.touch.client.core.Resizable;
import com.emitrom.gwt4.touch.client.core.Scroller;
import com.emitrom.gwt4.touch.client.core.config.Attribute;
import com.emitrom.gwt4.touch.client.core.config.ContainerConfig;
...
import com.emitrom.gwt4.touch.client.layout.Layout;
...
public class Container extends ComplexContainer implements HasLayout, Resizable {
     ...
     * @param animation
     */
    public void animateActiveItem(int activeItem, Animation animation) {
        animateActiveItem(activeItem, animation.getJSO());
    }

    public void animateActiveItem(Component activeItem, Animation animation) {
    ...
    public native boolean getAutoDestroy() /*-{
		var container = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		return container.getAutoDestroy();
    }-*/;

    public native boolean isHideOnMaskTap() /*-{
		var container = this.@com.emitrom.gwt4.touch.client.ui.Container::getOrCreateJsObj()();
		if (container != null) {
