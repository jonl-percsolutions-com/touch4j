/**************************************************************************
   NumberField.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
...
import com.emitrom.gwt4.touch.client.core.config.NumberConfig;
...
public class NumberField<T> extends Text<T> {
    ...
    public native double getMaxValue() /*-{
		var numberField = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (numberField != null) {
