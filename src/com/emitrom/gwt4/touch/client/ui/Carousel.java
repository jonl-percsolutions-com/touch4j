/**************************************************************************
 * Carousel.java is part of Touch4j 3.0. Copyright 2012 Emitrom LLC
 * 
...
public class Carousel extends Container implements HasUi, HasDirection, Navigable {
    ...
    public native int getActiveIndex() /*-{
		var carousel = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		if (carousel != null) {
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.containers.HasDirection#getDirection()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.containers.Navigable#next()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.emitrom.gwt4.touch.client.containers.Navigable#previous()
     */
    @Override
     ...
     * 
     * @see
     * com.emitrom.gwt4.touch.client.containers.HasDirection#setDirection(com
