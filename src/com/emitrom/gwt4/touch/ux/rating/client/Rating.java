/**************************************************************************
   Rating.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.ux.rating.client;
...
public class Rating extends Field implements HasValue<Integer>, IsEditor<LeafValueEditor<Integer>> {
	...
	protected native JavaScriptObject create(JavaScriptObject config) /*-{
		var count = this.@com.emitrom.gwt4.touch.ux.rating.client.Rating::itemsCount;
		var icon = this.@com.emitrom.gwt4.touch.ux.rating.client.Rating::showClearIcon;
		...
		component
				.addListener(
						...
						$entry(function(rating, newValue, oldValue) {
							var r = @com.emitrom.gwt4.touch.ux.rating.client.Rating::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rating);
							handler.@com.emitrom.gwt4.touch.ux.rating.client.ChangeHandler::onChange(Lcom/emitrom/gwt4/touch/ux/rating/client/Rating;II)(r,newValue,oldValue);
						}));
	}-*/;
