/**************************************************************************
   PullRefresh.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.ux.dataview.pullrefresh.client;
...
public class PullRefresh extends Component {
    ...
    public native void setPullRefreshText(String value)/*-{
		var pr = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
    ...
    public native void setPullTemplate(Template value)/*-{
		var pr = this.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()();
		pr
				.setPullTpl(value.@com.emitrom.gwt4.touch.client.core.Component::getOrCreateJsObj()());
    }-*/;
    ...
    public native void addPullRefreshHandler(PullRefreshHandler callback)/*-{
		...
		pr
				.setRefreshFn($entry(function(plugin) {
					callback.@com.emitrom.gwt4.touch.ux.dataview.pullrefresh.client.PullRefreshHandler::onRefresh()();
				}));
    }-*/;
