...
public class NativeGrid extends DataView {
	...
	public native GridColumn getColumn(int index)/*-{
		...
		var toReturn = @com.emitrom.gwt4.touch.ux.grid.client.core.GridColumn::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
		return toReturn;
	}-*/;
	...
	private static native JavaScriptObject _createNative(
		...
		for ( var i = 0; i < array.length; i++) {
			...
			if (string == 'horizontal') {
				...
				var feature = @com.emitrom.gwt4.touch.ux.grid.client.core.NativeGrid::createFeatureFrom(Ljava/lang/String;)(string);
