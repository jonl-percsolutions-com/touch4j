/**************************************************************************
   TouchCalendar.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.ux.touchcalendar.client;
...
import com.emitrom.gwt4.touch.ux.touchcalendar.client.core.nativepeers.NativeTouchCalendar;
...
public class TouchCalendar {
    ...
    public TouchCalendar(Store eventStore) {
        nativePeer = NativeTouchCalendar.create(eventStore, CalendarEventType.SIMPLE);
    }
    ...
    public TouchCalendar(Store eventStore, CalendarEventType eventType, String eventTemplate) {
        if (eventType.equals(CalendarEventType.SIMPLE)) {
            eventTemplate = "";
        }
        nativePeer = NativeTouchCalendar.create(eventStore, eventType, eventTemplate);
    }

    public TouchCalendar(Store eventStore, CalendarEventType eventType, String eventTemplate, JsDate selectedDate) {
        if (eventType.equals(CalendarEventType.SIMPLE)) {
            eventTemplate = "";
        }
        nativePeer = NativeTouchCalendar.create(eventStore, eventType, eventTemplate, selectedDate);
    }

    public TouchCalendar(Store eventStore, CalendarEventType eventType, JsDate selectedDate) {
        nativePeer = NativeTouchCalendar.create(eventStore, eventType, selectedDate);
    }
