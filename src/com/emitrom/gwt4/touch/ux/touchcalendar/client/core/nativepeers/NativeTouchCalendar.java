/**************************************************************************
   NativeTouchCalendar.java is part of Touch4j 3.0.  Copyright 2012 Emitrom LLC
 ...
 **************************************************************************/
package com.emitrom.gwt4.touch.ux.touchcalendar.client.core.nativepeers;

import com.emitrom.gwt4.touch.client.data.Store;
import com.emitrom.gwt4.touch.client.ui.Container;
import com.emitrom.gwt4.touch.ux.touchcalendar.client.core.AbstractCalendarPlugin;
import com.emitrom.gwt4.touch.ux.touchcalendar.client.core.TouchCalendarViewMode;
...
public class NativeTouchCalendar extends Container {
    ...
    public static NativeTouchCalendar create(Store store, CalendarEventType type, JsDate selectedDate) {
        return new NativeTouchCalendar(_createNativePeer(store.getJsObj(), type.getValue(), selectedDate, ""));
    }

    public static NativeTouchCalendar create(Store store, CalendarEventType type, String eventTemplate,
                    JsDate selectedDate) {
        return new NativeTouchCalendar(
                        _createNativePeer(store.getJsObj(), type.getValue(), selectedDate, eventTemplate));
    }
		...
		dataView
				.on(
						...
						$entry(function(cal, min, max, dir) {
							//var calendarView = @com.emitrom.gwt4.touch.ux.touchcalendar.client.TouchCalendar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cal);
							handler.@com.emitrom.gwt4.touch.ux.touchcalendar.client.core.handlers.PeriodChangeHandler::onPeriodChange(Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JsDate;Ljava/lang/String;)(min, max. dir);
		...
		dataView
				.on(
						...
						$entry(function(cal, newDate, prevDate) {
							//var calendarView = @com.emitrom.gwt4.touch.ux.touchcalendar.client.TouchCalendar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cal);
							handler.@com.emitrom.gwt4.touch.ux.touchcalendar.client.core.handlers.SelectionChangeHandler::onSelectionChange(Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JsDate;)(newDate,prevDate);
    ...
    private static native JavaScriptObject _createNativePeer(JavaScriptObject storeValue, String pluginType,
                    JsDate currentDate, String eventTemplate)/*-{
		var plugin = null;
