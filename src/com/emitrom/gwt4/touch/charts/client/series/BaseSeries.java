...
import com.emitrom.gwt4.touch.charts.client.ToolTip;
import com.emitrom.gwt4.touch.charts.client.handlers.RecordHandler;
import com.emitrom.gwt4.touch.charts.client.handlers.TitleChangeHandler;
		...
		jso
				.addListener(
						...
						$entry(function(title, index) {
							handler.@com.emitrom.gwt4.touch.charts.client.handlers.TitleChangeHandler::onTitleChange(Ljava/lang/String;I)(title, index);
						}));
    }-*/;
